...
/*
  ...
  */
  ...
  hero_sprite.overlap(platform3, groundTest);
  
  //powerHit.overlap(hero_sprite,powerUp);
  
  var offset = 15;
    if(platform3.overlapPixel(hero_sprite.position.x, hero_sprite.position.y+offset)==false)
    hero_sprite.velocity.y += GRAVITY;
    
    
    while(platform3.overlapPixel(hero_sprite.position.x, hero_sprite.position.y+offset))
    {
    hero_sprite.position.y--;
    hero_sprite.velocity.y = 0;;
    }
